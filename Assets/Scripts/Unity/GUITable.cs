...
namespace Scripts.Unity {
    ...
    public class GUITable {
        ...
        // *********************************** Update Functions ***********************************
        private bool PeriodPassed() {
            if (_previousPeriod < ClockTick) return false;
            _previousPeriod = ClockTick + Period;
            return true;
        }
        private bool CheckForUpdate() => UpdateEveryTick || (UpdatePeriodically && PeriodPassed()) || _newlySorted;
        ...
        public void Initialize() {
            ...
            if (UpdatePeriodically) _previousPeriod = ClockTick + Period;
